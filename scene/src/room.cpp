...
mesh create_room_mesh(float room_length, float room_depth, float room_height)
{
	...
	mesh wall_4 = mesh_primitive_quadrangle({0,room_depth,0.0f},{room_length*(0.1f),room_depth,0.0f},{room_length*(0.1f),room_depth,room_height},{0,room_depth,room_height});
	mesh wall_5 = mesh_primitive_quadrangle({room_length*(0.3f),room_depth,0.0f},{room_length*(0.7f),room_depth,0.0f},{room_length*(0.7f),room_depth,room_height},{room_length*(0.3f),room_depth,room_height});
	mesh wall_6 = mesh_primitive_quadrangle({room_length*(0.9f),room_depth,0.0f},{room_length,room_depth,0.0f},{room_length,room_depth,room_height},{room_length*(0.9f),room_depth,room_height});
