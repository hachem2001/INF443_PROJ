...
{
	glm::mat4 mv = orig_view * src->objectToWorldMatrix;
	glm::mat4 portal_cam =
		...
		* glm::rotate(glm::mat4(1.0), glm::radians(180.0f), glm::vec3(0.0, 1.0, 0.0))
		...
		//    transformations:
		* glm::inverse(dst->objectToWorldMatrix);
	return portal_cam;
}
...
void scene_structure::initialize()
{
	...
	portals[0].objectToWorldMatrix = glm::translate(glm::mat4(1), glm::vec3(0, 1, -2));
	portals[1].objectToWorldMatrix = glm::rotate(glm::mat4(1), -90.0f, glm::vec3(0, 1, 0)) * glm::translate(glm::mat4(1), glm::vec3(0, 1.2, -2));

	portal12.initialize_data_on_gpu(portals[0]);
	portal21.initialize_data_on_gpu(portals[1]);
}
